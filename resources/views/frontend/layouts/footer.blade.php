...
<footer class="footer footer_type_2">
  <div class="footer-top container">
    <div class="block-newsletter">
      <h3 class="block__title">Sign up now & get 10% off</h3>
  ...
  <div class="footer-middle container">
    <div class="row row-cols-lg-5 row-cols-2">
      <div class="footer-column footer-store-info col-12 mb-4 mb-lg-0">
        <div class="logo">
          <a href="index.html">
            <img src="Users/images/logo.png" alt="Uomo" class="logo__image d-block">
          </a>
        </div><!-- /.logo -->
...
<div class="aside aside_right overflow-hidden customer-forms" id="customerForms">
  <div class="customer-forms__wrapper d-flex position-relative">
    <div class="customer__login">
      ...
      <form action="{{route('login.submit')}}" method="POST" class="aside-content">
        @csrf
        <div class="form-floating mb-3">
          <input name="email" type="email" class="form-control form-control_gray" id="customerNameEmailInput" required="required" value="{{old('email')}}" placeholder="name@example.com">
        ...
        <div class="form-label-fixed mb-3">
          ...
          <input name="password" id="customerPasswordInput" class="form-control form-control_gray" required="required" value="{{old('password')}}" type="password" placeholder="********">
          @error('password')
            <span class="text-danger">{{$message}}</span>
        @enderror
        </div>
    ...
    <div class="customer__register">
      ...
      <form action="{{route('register.submit')}}" method="POST" class="aside-content">
        @csrf
        <div class="form-floating mb-4">
          <input type="text" class="form-control form-control_gray" name="name" id="name" value="{{old('name')}}" placeholder="Your Name">
          <label for="registerUserNameInput">Name</label>
          @error('name')
          <span class="text-danger">{{$message}}</span>
        @enderror
        </div>
        ...
        <div class="form-floating mb-4">
          <input  type="email" class="form-control form-control_gray" name="email" value="{{old('email')}}" placeholder="user@company.com">
        ...
        <div class="form-label-fixed mb-4">
          ...
          <input  id="registerPasswordInput" class="form-control form-control_gray" type="password" name="password" value="{{old('password')}}" placeholder="*******">
          @error('password')
          <span class="text-danger">{{$message}}</span>
      @enderror
        </div>
        ...
        <div class="form-label-fixed mb-4">
          <label for="registerPasswordInput" class="form-label">Confirm Password *</label>
          <input id="registerPasswordInput" class="form-control form-control_gray" type="password" name="password_confirmation" value="{{old('password_confirmation')}}" placeholder="*******">
...
{{-- <div class="aside aside_right overflow-hidden cart-drawer" id="cartDrawer">
  ...
  <div class="aside-content cart-drawer-items-list">
    <div class="cart-drawer-item d-flex position-relative">
      <div class="position-relative">
        <a href="product1_simple.html">
          <img loading="lazy" class="cart-drawer-item__img" src="Users/images/cart-item-1.jpg" alt="">
        </a>
      </div>
    ...
    <div class="cart-drawer-item d-flex position-relative">
      <div class="position-relative">
        <a href="product1_simple.html">
          <img loading="lazy" class="cart-drawer-item__img" src="Users/images/cart-item-2.jpg" alt="">
        </a>
      </div>
      <div class="cart-drawer-item__info flex-grow-1">
    ...
    <div class="cart-drawer-item d-flex position-relative">
      <div class="position-relative">
        <a href="product1_simple.html">
          <img loading="lazy" class="cart-drawer-item__img" src="Users/images/cart-item-3.jpg" alt="">
        </a>
      </div>
      <div class="cart-drawer-item__info flex-grow-1">
  ...
  <div class="modal-dialog modal-fullscreen">
    <div class="sitemap d-flex">
      <div class="w-50 d-none d-lg-block">
        <img loading="lazy" src="Users/images/nav-bg.jpg" alt="Site map" class="sitemap__bg">
            ...
            <div class="swiper-container js-swiper-slider"
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide product-single__image-item">
                  <img loading="lazy" src="Users/images/products/quickview_1.jpg" alt="">
                </div>
                <div class="swiper-slide product-single__image-item">
                  <img loading="lazy" src="Users/images/products/quickview_2.jpg" alt="">
                </div>
                <div class="swiper-slide product-single__image-item">
                  <img loading="lazy" src="Users/images/products/quickview_3.jpg" alt="">
                </div>
                <div class="swiper-slide product-single__image-item">
                  <img loading="lazy" src="Users/images/products/quickview_4.jpg" alt="">
                </div>
              </div>
      ...
      <div class="row p-0 m-0">
        <div class="col-md-6 p-0 d-none d-md-block">
          <div class="newsletter-popup__bg h-100 w-100">
            <img loading="lazy" src="Users/images/newsletter-popup.jpg" class="h-100 w-100 object-fit-cover d-block" alt="">
          </div>
        </div>
        <div class="col-md-6 p-0 d-flex align-items-center">
          <div class="block-newsletter w-100">
            ...
            <p>Be the first to get the latest news about trends, promotions, and much more!</p>
            <form action="https://uomo-html.flexkitux.com/Demo3/index.html" class="footer-newsletter__form position-relative bg-body">
...
<script src="{{asset('Users/js/plugins/jquery.min.js')}}"></script>
<script src="{{asset('Users/js/plugins/bootstrap.bundle.min.js')}}"></script>
<script src="{{asset('Users/js/plugins/bootstrap-slider.min.js')}}"></script>

<script src="{{asset('Users/js/plugins/swiper.min.js')}}"></script>
<script src="{{asset('Users/js/plugins/countdown.js')}}"></script>
